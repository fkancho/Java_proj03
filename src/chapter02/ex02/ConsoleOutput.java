	...
	public static void main(String[] args) {
		...
		System.out.println("안녕하세요");
		 ...
		 int a = 5;  // 정수형 a 변수에 정수값 5를 넣어라
		 			...
		 			// == : 같다.
		 System.out.println(a); //변수를 출력할 때에는 ""를 넣으면 안 됨
		...
		//3. System.out.printf(""); : , 뒤의 변수값을 ""안으로 가져옴.
		 ...
		 //%o : 뒤의 8진수 값을 불러올 때 사용
		  ...
		  //%f : 문자열 뒤의 실수 값 불러올 떄 사용
		  //%4.2f : 4: 전체 4자리, 2소숫점이해 2자리까지 잘라서 출력
		  
		  System.out.printf("나믜 몸무게는 %f입니다 \n", 75.123456789);
		  System.out.printf("나믜 몸무게는 %4.2f입니다 \n", 75.123456789);
		 
		  System.out.printf("오늘의 온도는 %f도이고, %s %f 입니다 \n", 17.33, "나의 몸무게는", 75.5 );
